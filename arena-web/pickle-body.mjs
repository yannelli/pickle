...
export function bodyProfile(shape) { return Object.hasOwn(BODY_PROFILES, shape) ? BODY_PROFILES[shape] : BODY_PROFILES.long; }

export function bodyRadius(shape, angle, width, height) {
...
export function bodyPoints(shape, width, height, count = 72) {
  return Array.from({ length: count }, (_, i) => {
    const angle = i * Math.PI * 2 / count, r = bodyRadius(shape, angle, width, height);
