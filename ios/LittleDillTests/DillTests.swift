...
final class DillTests: XCTestCase {
    ...
    func testArenaMembranesDentWherePiecesPressOrReachAWallAndRelaxWhenFree() throws {
        ...
        XCTAssertEqual(ArenaShape(try arenaPlayer(["variety":"garlic"]),r:50).profile,.pear)
        XCTAssertEqual(ArenaShape(try arenaPlayer(["variety":"garlic"]),r:50).lean,0)
        XCTAssertEqual(ArenaShape(try arenaPlayer(["variety":"gherkin"]),r:50).profile,.gherkin)
